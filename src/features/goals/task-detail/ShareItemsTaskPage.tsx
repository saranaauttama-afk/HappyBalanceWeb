        ...
        <main className="space-y-4 px-4 py-4">
          ...
          <section className="rounded-3xl border border-white/70 bg-white/80 p-4 shadow-[0_18px_40px_rgba(31,47,61,0.1)] backdrop-blur">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <div className="min-w-0">
                    <h2 className="text-lg font-semibold text-slate-900">แบ่งปันสิ่งของให้เพื่อนร่วมงาน</h2>
                    <p className="mt-1 text-sm text-slate-500">
                      เก็บจำนวนครั้งของการแบ่งปันเล็ก ๆ ที่ช่วยสร้างความสัมพันธ์ที่ดีในที่ทำงาน
                    </p>
                  </div>
                </div>
                <p className="mt-3 text-sm text-slate-500">
                  บันทึกจำนวนครั้งที่แบ่งปันสิ่งของ อย่างน้อย 1 ครั้งจะได้ 1 คะแนน
                </p>
              </div>
              <span
            ...
            <div className="mt-5 rounded-[28px] border border-[#e8f2ec] bg-[linear-gradient(180deg,#f8fffb_0%,#eefbf5_100%)] p-4">
              <p className="text-center text-sm text-slate-500">จำนวนครั้งที่แบ่งปันให้เพื่อนร่วมงานวันนี้</p>
              <div className="mt-4 flex items-center justify-center gap-3">
                ...
                <div className="min-w-[112px] rounded-2xl bg-white px-5 py-3 text-center shadow-sm">
                  <p className="text-3xl font-bold text-slate-900">{shareCount}</p>
