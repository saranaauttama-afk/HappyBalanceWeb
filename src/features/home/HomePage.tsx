...
const FALLBACK_ARTICLES: Article[] = [
  {
    ...
    description: "เทคนิคเล็ก ๆ ที่ช่วยให้จัดสมดุลกาย ใจ และงานได้ดีขึ้นทุกวัน ตั้งแต่การวางแผนเวลา การตั้งขอบเขตที่ชัดเจน ไปจนถึงการให้รางวัลตัวเองอย่างสม่ำเสมอ",
  },
  {
    id: "fallback-2",
    title: "ดูแลใจให้แข็งแรงในวันที่เหนื่อย",
    description: "วิธีรีเซ็ตอารมณ์และฟื้นพลังใจแบบทำได้จริงในเวลาไม่นาน เช่น การหายใจลึก ๆ การเขียนสิ่งที่รู้สึกขอบคุณ หรือแค่หยุดพักจากหน้าจอสักครู่",
  },
  {
    id: "fallback-3",
    title: "นอนหลับให้ดีคือการดูแลสุขภาพขั้นพื้นฐาน",
    description: "การนอนหลับอย่างมีคุณภาพส่งผลต่อทั้งร่างกายและจิตใจมากกว่าที่คิด เรียนรู้วิธีปรับ sleep hygiene ง่าย ๆ ที่ช่วยให้หลับลึกและตื่นมาสดชื่น พร้อมเผชิญวันใหม่อย่างเต็มที่",
  },
  {
    id: "fallback-4",
    title: "กินอย่างไรให้ใจดีขึ้น",
    description: "อาหารที่เราเลือกกินส่งผลต่ออารมณ์และระดับพลังงานตลอดวัน ผักใบเขียว ธัญพืช และโปรตีนดีมีส่วนช่วยให้สมองทำงานได้ดีขึ้น ลองเริ่มปรับมื้ออาหารทีละเล็กน้อยแล้วสังเกตความเปลี่ยนแปลง",
  },
  {
    id: "fallback-5",
    title: "ขยับร่างกายแค่ 10 นาทีก็เปลี่ยนอารมณ์ได้",
    description: "ไม่จำเป็นต้องออกกำลังกายหนักเพื่อให้รู้สึกดีขึ้น การเดินเร็ว ยืดเหยียด หรือขยับร่างกายเบา ๆ เพียง 10 นาที ช่วยกระตุ้น endorphin ลดความเครียด และเพิ่มพลังงานได้อย่างรวดเร็ว",
  },
  {
    id: "fallback-6",
    title: "ความสัมพันธ์ที่ดีช่วยให้มีสุขภาพที่ดีขึ้น",
    description: "งานวิจัยพบว่าคนที่มีความสัมพันธ์ใกล้ชิดที่ดีมีสุขภาพกายและใจดีกว่าในระยะยาว การพูดคุย รับฟัง และแสดงความห่วงใยซึ่งกันและกันเป็นการลงทุนที่คุ้มค่าที่สุดอย่างหนึ่งในชีวิต",
  },
  {
    id: "fallback-7",
    title: "รู้จักตัวเองให้มากขึ้นด้วยการบันทึกประจำวัน",
    description: "การเขียนบันทึกความรู้สึกและเหตุการณ์ในแต่ละวันช่วยให้เห็นรูปแบบพฤติกรรมและอารมณ์ของตัวเอง ทำให้จัดการกับความเครียดและตัดสินใจได้ดีขึ้น เริ่มต้นด้วยเพียง 5 นาทีก่อนนอนก็เพียงพอ",
  },
];
